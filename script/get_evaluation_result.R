...
bi.lstm.prediction.dir = "/doc2/wuchen/baseline/DeepLineDP-master/output/prediction/Bi-LSTM/"
cnn.prediction.dir = "/doc2/wuchen/baseline/DeepLineDP-master/output/prediction/CNN/"
dbn.prediction.dir = "/doc2/wuchen/baseline/DeepLineDP-master/output/prediction/DBN/"
bow.prediction.dir = "/doc2/wuchen/baseline/DeepLineDP-master/output/prediction/BoW/"

bow2.prediction.dir = "/doc2/wuchen/experiment/RQ1/1.0/DeepLineDP-master/output/prediction/BoW/"
dbn2.prediction.dir = "/doc2/wuchen/experiment/RQ1/1.0/DeepLineDP-master/output/prediction/DBN/"
...
gcn.result = get.file.level.eval.result.GCN(prediction_dir, "EU-LLDP(DP)")
baseline.result = get.file.level.eval.result.GCN(original_prediction_dir, "DeepLineDP")
dbn2.result = get.file.level.eval.result(dbn2.prediction.dir, "EU-LLDP(DBN)")
bow2.result = get.file.level.eval.result(bow2.prediction.dir, "EU-LLDP(BOW)")


all.result = rbind(gcn.result, baseline.result,dbn2.result,dbn.result, bow2.result,bow.result, cnn.result,bi.lstm.result )
...
custom_order <- c("EU-LLDP(DP)", "DeepLineDP", "EU-LLDP(DBN)", "DBN","EU-LLDP(BOW)","BoW","CNN","Bi-LSTM")  
...
error.prone.result.dir = '/doc2/wuchen/baseline/DeepLineDP-master/output/ErrorProne_result/'
...
deepline.dp.line.result$technique = 'EU-LLDP(DP)'
...
custom_order <- c("EU-LLDP(DP)", "DeepLineDP", "N.gram","ErrorProne","RF")  
